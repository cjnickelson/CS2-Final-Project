...
void Player::saveGame()
{
	...
	s.slots[15] = s.slots[13] + s.slots[14]+(s.slots[13]>=63?35:0);
...
// this function displays the player statistics based on their number of games played and their vector of scores
